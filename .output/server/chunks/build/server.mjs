import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, computed, toValue, onServerPrefetch, reactive, defineAsyncComponent, inject, unref, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, createVNode, resolveDynamicComponent, effectScope, nextTick, toRef, mergeProps, getCurrentScope, withCtx, isReadonly, toRaw, useSSRContext, isRef, isShallow, isReactive } from 'vue';
import { k as klona, l as parseURL, m as encodePath, n as decodePath, o as hasProtocol, q as isScriptProtocol, j as joinURL, w as withQuery, r as defuFn, s as sanitizeStatusCode, t as getContext, $ as $fetch$1, v as baseURL, x as hash, y as defu, e as createError$1, z as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CGFQqvGK.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-BSYJnzYR.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-B0xrZwrw.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B6bQ9NsK.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BBbEy6l4.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useAppConfig as d, entry_default as default, encodeRoutePath as e, useAsyncData as f, navigateTo as n, resolveRouteObject as r, useRouter as u };
